...
import type { GenderPreference, Listing, ListingStatus, PricePeriod, RoomType } from "@/lib/types";
...
export default function Browse() {
  ...
  const filters = useMemo(
    ...
    [q, schoolId, state, lga, roomsParam, gender, maxPrice, pricePeriod, status, savedOnly],
  );
